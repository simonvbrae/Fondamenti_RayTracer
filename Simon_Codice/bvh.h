...
bool bvh_node::hit(const ray& r, float t_min, float t_max, hit_record& rec, float time) const {
	if (box.hit(r, t_min, t_max)) {
		hit_record left_rec, right_rec;
		bool hit_left = left->hit(r, t_min, t_max, left_rec, time);
		bool hit_right = right->hit(r, t_min, t_max, right_rec, time);
